var win_mainMenu = `<div style="display: flex;">
					<span style="cursor: -webkit-grab;">
						...
						<div id="mainmenu" style="display:block">
							...
							<br>
							<button id="wfmtimecalc" style="margin: 4px 0px 5px 5px; height: 30px; min-width: 105px; padding-top:8px;" class="btn-main dobigger"><span style="font-size:18px;float:left; position:relative; top:-5px; left:0px;">📟</span> Time Calc</button>
							<br>
