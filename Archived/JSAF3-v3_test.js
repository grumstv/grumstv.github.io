...
function firstLoadPage() { //первичаня загрузка страницы
    if (window.location.href.indexOf('skyeng.autofaq.ai') === -1 || window.location.href.indexOf('skyeng.autofaq.ai/login') > 0) {
        ...
        if (window.location.href.indexOf('billing-marketing.skyeng.ru/accrual-operations/create') !== -1 ) {
            include("https://grumstv.github.io/Modules/Consideration.js") // подключаем модуль вывода подсказок при создании компенсации компенсации
        }
    } else {
...
function prepTp() { //функция подготовки расширения ТП
    ...
    let gfgScript = ["https://grumstv.github.io/jquery-3.6.0.js", // подключаем модуль обработки JQuery
        ...
        "https://grumstv.github.io/Modules/Link.js", // модуль ссылкера (L)inks
        "https://grumstv.github.io/Modules/TemplatesFuncs.js", // модуль с функциями при работе с шаблонами"
        "https://grumstv.github.io/Modules/Settings.js", // модуль настроек расширения
	    "https://grumstv.github.io/Modules/AlarmClock.js", // модуль будильника
        "https://grumstv.github.io/Modules/CustomTemplates.js", // модуль кастомных собственных шаблонов
		"https://grumstv.github.io/Modules/Statistica.js", // модуль кнопки "Статистика" и вложенных функций
		"https://grumstv.github.io/Modules/Calendar.js", // модуль кнопки "Календарь"
        "https://grumstv.github.io/Modules/Linksdostup.js",  // модуль дополнительного окна ссылок, где требуется запрос доступа к ресурсам
        "https://grumstv.github.io/Modules/Userinfo.js", // модуль UserInfo в виде вензеля с разными функциями и возможностями
        "https://grumstv.github.io/Modules/RefuseForm.js", // модуль формы отказа от помощи
		"https://grumstv.github.io/Modules/VoiceHelper.js", // модуль голосового помощника
        "https://grumstv.github.io/Modules/Marks.js", // модуль просмотра оценок пользователя
        "https://grumstv.github.io/Modules/AutoRespond.js", // модуль автоответа по таймеру
        "https://grumstv.github.io/Modules/JiraSearch.js", // модуль поиска по Jira
        "https://grumstv.github.io/Modules/Smartroom.js", // модуль формы пожеланий Smartroom
        "https://grumstv.github.io/Modules/TaskCreate.js", // модуль создания задач в СРМ2 с помощью интеграции АФ
        "https://grumstv.github.io/Modules/Themes.js", // модуль выставления тегов и тематик
        "https://grumstv.github.io/Modules/ChatHistory.js", // модуль просмотра истории чатов
        "https://grumstv.github.io/Modules/BinBankInfo.js", // модуль просмотра участников группы в L
        "https://grumstv.github.io/Modules/Addstat.js", // модуль дополнительного окна статистики, расположенного в кнопке L
        "https://grumstv.github.io/Modules/LessonStatus.js", // модуль просмотра статуса уроков по П или по П и У
        "https://grumstv.github.io/Modules/OperatorStatuse.js", // подключаем модуль статусов операторов в CRM2
		"https://grumstv.github.io/Modules/OpStatusMM.js", //подключаем модуль отправки статусов
        "https://grumstv.github.io/Modules/AFOperatorStatus.js", // подключаем модуль статусов операторов и количества чатов на них
        ...
        "https://grumstv.github.io/Modules/Radio.js", // подключаем модуль статусов операторов и количества чатов на них
...
function prepKC() { //функция подготовки расширения КЦ
    ...
    let gfgScript = ["https://grumstv.github.io/jquery-3.6.0.js", // подключаем модуль обработки JQuery
        "https://grumstv.github.io/Modules/LinkKC.js", // модуль ссылкера (L)inks
        "https://grumstv.github.io/Modules/TemplatesFuncs.js", // модуль с функциями при работе с шаблонами"
        "https://grumstv.github.io/Modules/Settings.js", // модуль настроек расширения
	    "https://grumstv.github.io/Modules/AlarmClock.js", // модуль будильника
        "https://grumstv.github.io/Modules/CustomTemplates.js", // модуль кастомных собственных шаблонов
